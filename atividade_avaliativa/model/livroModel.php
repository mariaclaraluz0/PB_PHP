...
class Livro{
   ...
   public function __construct($id, $titulo, $autor, $ano_publicacao){
    $this->id= $id;
    $this->titulo= $titulo;
    $this->autor= $autor;
   ...
   public function salvar(){
        ...
        $stmt->execute(['id' => $this->id, 'titulo' => $this->titulo, 'autor' => $this->autor, 'ano_publicacao' => $this->ano_publicacao]);
    }
...
WHERE id = :id");
        $stmt->execute(['id' => $id, 'titulo' => $this->titulo, 'autor' => $this->autor, 'ano_publicacao' => $this->ano_publicacao ]);
    }
